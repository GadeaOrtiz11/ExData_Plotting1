...
plot(electric_power_data$DateTime, electric_power_data$Global_active_power, type = "l", 
     xlab = "", ylab = "Global Active Power")
plot(electric_power_data$DateTime, electric_power_data$Voltage, type = "l",
...
plot(electric_power_data$DateTime, electric_power_data$Global_reactive_power, type = "l",
